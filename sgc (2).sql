...
--
-- Host: 127.0.0.1
-- Generation Time: 02-Maio-2018 às 01:20
...
(10, 'A', 4, 2, 12345678000190),
(11, 'B', 4, 2, 12345678000190),
(12, 'C', 4, 2, 12345678000190),
(13, 'D', 4, 2, 12345678000190),
(14, 'E', 4, 2, 12345678000190);
...
(12345678000190, 'Residencial PSI', 5, 31930030, 'Rua Luiza Batista Guedes', '50', 'Ipê', 'Belo Horizonte', 'MG');
...
INSERT INTO `condominos` (`CONDOMINO_CPF`, `CONDOMINO_NOME`, `CONDOMINO_EMAIL`, `CONDOMINO_SINDICO`, `CONDOMINO_FK_APARTAMENTO`) VALUES
(12345678908, 'Joselito', 'joselito@gmail.com', 0, 114),
(12345678909, 'Edson L F Santos', 'jesusfreakedson@gmail.com', 1, 113);
...
(1, 'Edson L F Santos', 'jesusfreakedson@gmail.com', '$2y$10$J6JhkKtDrmUbkKO9cjXpmO70q9vH3Z0AdClHuSvgq47996a7UUL9K', 'B3cA09erls6rVpz0G7R8g1uP3k1I3YjTbGLj5xwXCVsbnwDkn00kCZHvILE3', '2018-03-12 20:44:35', '2018-03-12 20:44:35');
...
--
ALTER TABLE `reunioes`
  MODIFY `REUNIAO_ID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
